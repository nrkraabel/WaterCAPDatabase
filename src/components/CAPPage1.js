      ...
      <Page.Content>
        <Grid.Row>
          <Grid.Col lg={6}>
            ...
            <Card
              title={CAP.program2.name}
              isCollapsible
              isClosable
              body={CAP.program2.desc}
            />
            <Card
              title="Eligibility"
              isCollapsible
              isClosable
              body={CAP.program2.eligilibity}
            />
            <a
              href={CAP.program2.URL}
              rel="noreferrer"
          ...
          <Grid.Col lg={6}>
            ...
            <StampCard
              color="red"
              icon="droplet"
              header={<div>Program Type: {CAP.program2.types}</div>}
              footer={
                <div>
            ...
            <StampCard
              ...
              icon="user"
              header={
                <div>Program Target Population: {CAP.program2.hh_targeted}</div>
              }
            />
            {CAP.Covid_CAP === "Yes" ? (
              <StampCard
