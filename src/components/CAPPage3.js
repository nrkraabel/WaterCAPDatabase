      ...
      <Page.Content>
        <Grid.Row>
          <Grid.Col lg={6}>
            ...
            <Card
              title={CAP.program4.name}
              isCollapsible
              isClosable
              body={CAP.program4.desc}
            />
            <Card
              title="Eligibility"
              isCollapsible
              isClosable
              body={CAP.program4.eligilibity}
            />
            <a
              href={CAP.program4.URL}
              rel="noreferrer"
          ...
          <Grid.Col lg={6}>
            ...
            <StampCard
              color="red"
              icon="droplet"
              header={<div>Program Type: {CAP.program4.types}</div>}
              footer={
                <div>
            ...
            <StampCard
              ...
              icon="user"
              header={
                <div>Program Target Population: {CAP.program4.hh_targeted}</div>
              }
            />
            {CAP.Covid_CAP === "Yes" ? (
              <StampCard
